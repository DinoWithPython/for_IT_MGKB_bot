...
def admin_bot(bot):
    ...
    def add_black_list(message):
        ...
        bot.send_message(
            message.chat.id, f"Человек с id {add_user_list} добавлен в пользователи."
        )
